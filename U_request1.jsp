...
<div class="main">
 ...
 <% try 
	...
	String query="select * from searchrequest where uname='"+username+"' "; 
...
%>
	<h1 class="style18">Hi Mr.<%=username %> You are already Requested and View Response  </h1>
	...
	<h3><a href="UserMain.jsp">Back</a></h3>
	 <%
			...
			stss.executeUpdate("insert into searchrequest(uname,dt,res) values ('"+username+"','"+reqdt+"','"+status+"')"); 
