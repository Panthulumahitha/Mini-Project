  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <h2>View <span class="style3"> Mobile User</span> & Authorize</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
			  <table width="924" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#162D3D">
  	   <tr>
   		 <td width="241" height="32" bgcolor="#FF0000"><div align="center" class="style6 style12">Mobile User  Image </div></td>
    	 <td width="168" bgcolor="#FF0000"><div align="center" class="style13"><span class="style6 style12">Mobile User</span> Name </div></td>
      ...
      try{
        ...
        %>
              <tr>
                <td><div align="center" class="style10 style14">
