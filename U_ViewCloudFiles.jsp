...
.style15 {font-family: "Courier New", Courier, monospace; color: #FF0000; font-weight: bold; }
-->
</style>
</head>
<body>
...
<%
  ...
  <tr>
    <td height="29"><div align="center" class="style12 style13"><%=s2%></div></td>

    <td><div align="center" class="style15"><%=s3%></div></td>
	  <td><div align="center" class="style15"><%=s8%></div></td>
  </tr>
