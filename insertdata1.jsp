...
%>
					<p><a href="RegisterU.jsp">Back</a>  <a href="index.html">Home</a> </p>
<%
	} else {
					PreparedStatement ps = connection
							.prepareStatement("INSERT INTO user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?) ");
