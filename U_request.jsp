...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Request Search Control &amp; <span class="style8">Permission</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
 ...
 <% try 
	{
      		...
      		String on=request.getParameter("t43");
	...
	String status="No",attack="No", recover="....",process="Response Service";
...
if ( rs.next() )
{
 ...
 String sk="req";
			...
			stss.executeUpdate("insert into userrequest(username,fnamereq,ownername,reqdate,resdate,mac,secretkey,resstatus) values ('"+username+"','"+file+"','"+on+"','"+reqdt+"','"+respdate+"','"+mac+"','"+sk+"','"+status+"')"); 
		
%>
 <h1 class="style18">Hi Mr.<%=username %> ur request sent to Cloud  Server </h1>
 <h3><a href="UserMain.jsp">Back</a></h3>
 <%
}else{
	
	%>
	<h1 class="style18">Hi Mr.<%=username %> ur requesting File is not available in Cloud  </h1>
