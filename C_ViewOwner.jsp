...
.style14 {font-family: "Courier New", Courier, monospace; color: #FF0000; font-weight: bold; }
-->
</style>
</head>
<body>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      try{
        ...
        %>
                <tr>
                  <td><input  name="image" type="image" class="style12" src="images.jsp?imgid=<%=ii%>" alt="Submit" width="100" height="100" />                  </td>
                  ...
                  <td><span class="style14"><%=s7%></span></td>
                  <%if(s10.equalsIgnoreCase("Waiting")){
          	 %>
                  <td><a href="C_Oautorize.jsp?id=<%=i%>&st=<%=s10%>" class="style14">Waiting</a></td>
                  <%
               }
           if(s10.equalsIgnoreCase("Authorized"))
           {
          	 %>
                  <td><a href="C_Oautorize.jsp?id=<%=i%>&st=<%=s10%>" class="style14">Authorized</a></td>
                  <%
