...
String onname=(String)application.getAttribute("onname");
  ...
  <tr>
    <td height="29"><div align="center" class="style12 style11"><strong><%=s2%></strong></div></td>
    <td><div align="center" class="style12 style11"><strong><%=s3%></strong></div></td>
    <td><div align="center" class="style12 style11"><strong><%=s5%></strong></div></td>
	  <td><div align="center" class="style12 style11"><strong><%=s6%></strong></div></td>
	  <td><div align="center" class="style12 style11"><strong><%=s8%></strong></div></td>
  </tr>
