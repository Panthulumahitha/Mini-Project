...
<div class="main">
  ...
  <tr>
   <td width="178" bgcolor="#FF0000"><div align="center" class="style5"><em>Owner  Name</em></div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style8">Encrypted Contents</div></td>
      <td width="178" bgcolor="#FF0000"><div align="center" class="style8">Decrypted Contents</div></td>
...
<%
  ...
  <tr>
    ...
    <td><div align="center" class="style11"><textarea cols="25" rows="15" ><%=s4%></textarea></div></td>
     <td><div align="center" class="style11"><textarea cols="25" rows="15" ><%=decryptedValue%></textarea></div></td>
