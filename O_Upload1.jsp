...
<%
			...
			{
				%>
				<h2>Data Deduplication Found !!! Pl Try To upload Other Files !!! </h2>
				<%
		...
		Statement st22 = connection.createStatement();
			...
			String dt = strDate + "   " + strTime;
				...
				String type="File Data Deduplication Found";
				String strQuery2 = "insert into Dedup_log(oname,fname,type,dt) values('"+ownernam+"','"+file+"','"+type+"','"+dt+"')";
